...
namespace App_Estudios_G7.Models
{
    ...
    public partial class Sistema_estudiosEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> BUSCAR_USUARIOS1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("BUSCAR_USUARIOS1");
        }
        ...
        public virtual int NUEVO_USER1(string nuevo_Nick, string nuevo_contra, string nuevo_nombre_1, string nuevo_nombre_2, string nuevo_apellido_1, string nuevo_apellido_2, Nullable<int> nuevo_edad, string nuevo_correo, string nuevo_rol)
        {
            var nuevo_NickParameter = nuevo_Nick != null ?
                new ObjectParameter("Nuevo_Nick", nuevo_Nick) :
                new ObjectParameter("Nuevo_Nick", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("NUEVO_USER1", nuevo_NickParameter, nuevo_contraParameter, nuevo_nombre_1Parameter, nuevo_nombre_2Parameter, nuevo_apellido_1Parameter, nuevo_apellido_2Parameter, nuevo_edadParameter, nuevo_correoParameter, nuevo_rolParameter);
        }
